...
class Test_Library_Template(unittest.TestCase):
    ...
    def test_reserve_book(self):
        ...
        self.assertEqual(self.lib.reserve_book('Kevin', 'b', 10, 20, Mock_Reservation), (False, 'reservation'))
        self.assertEqual(self.lib.reserve_book('Kevin', 'a', 10, 30, Mock_Reservation), (True, 2))
    ...
    def test_check_reservation(self):
        ...
        self.lib._reservations.append(Mock_Reservation(10, 'a', 'Kevin'))
        self.assertTrue(self.lib.check_reservation('Kevin', 'a', 5))
        self.assertFalse(self.lib.check_reservation('Kevin', '5', 5))
